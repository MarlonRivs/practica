...
<html>
    <head>
        ...
        <style>
            .product-card {
                ...
                body{
                    background-image: url("img/nv3.jpg");
    ...
    <%
        ...
        String idDestacados = request.getParameter("id_destacados");
        ...
        producto.put("id_destacados", idDestacados);
    ...
    <body style="                    background-image: url('img/nv3.jpg');
                    background-size: cover;
                    background-repeat: no-repeat;
                    background-attachment: fixed;">
        ...
        <div class="card container" style="margin-bottom:200px; padding: -30px; margin-top: 150px;">
            <div class="row mt-4">
                <div class="col-md-12" style="padding:20px;" id="producto_<%= request.getParameter("id_destacados")%>">
                    <div class="product-card">
                        <div class="row">
                            ...
                            <div class="col-md-6" style="padding:60px;">
                                ...
                                <p id="precio_<%= request.getParameter("id_destacados")%>">Precio: $<span class="precio-unitario"><%= request.getParameter("precio")%></span></p>
                                <div class="mb-3">
                                    <label for="cantidad_<%= request.getParameter("id_destacados")%>" class="form-label">Cantidad:</label>
                                    <input type="number" class="form-control cantidad" id="cantidad_<%= request.getParameter("id_destacados")%>"
                                           name="cantidad" value="1" min="1" data-id="<%= request.getParameter("id_destacados")%>">
                                </div>
                                <div class="mb-3">
                                    <label for="precioTotal_<%= request.getParameter("id_destacados")%>" class="form-label">Precio Total:</label>
                                    <input type="text" class="form-control precio-total" id="precioTotal_<%= request.getParameter("id_destacados")%>"
                                ...
                                <form action="almacen.jsp" method="post">
                                    <input type="hidden" name="id_destacados" value="<%= request.getParameter("id_destacados")%>">
                            ...
                            <div class="col-md-6" style="padding:10px; margin-top: -60px;">
