...
<html>
    <head>
        ...
        <style>
            *{
            ...
            body{ background-image: url("img/nv2.jpg"); background-size: cover; background-repeat: no-repeat; margin-top: -120px;  background-attachment: fixed;}
    ...
    <body>
        ...
        <h1 class='container' style="text-align: left; margin-top: 290px; color:black">Artículos para dormir</h1>
        ...
        <div class="container" style="margin-top: 10px;  margin-bottom: 200px;">
            <div class="container">
                <div class="row" style="width: 100%; height: 100%;a">
                  <% 
                    int count = 0; // Inicia el conteo de las cartas mostradas.
                    st = conexion.prepareStatement("SELECT p.id_accesorios, a.Nombre, a.Precio, a.Descripcion, a.Foto FROM productos p INNER JOIN accesorio a ON p.id_accesorios = a.id_accesorios;");
                    rs = st.executeQuery();
                    while (rs.next()) {
                  %>
                              ...
                              <div class="col-md-6">
                                  <div class="card-body" style="color: black;">        
                                      ...
                                      <form action="agregarAlCarrito.jsp" method="post">
                                          <input type="hidden" name="id_accesorios" value="<%= rs.getInt("id_accesorios")%>">
