...
<html>
    ...
    <body>
        ...
        <h1 class='container' style="text-align: left; margin-top: 290px; color:black;">Camas</h1>
         ...
         <div class="container" style="margin-bottom:100px;">
             <div class="row">
                 <%            int count = 0; // Inicia el conteo de las cartas mostradas.
                     st = conexion.prepareStatement("SELECT p.id_cama, c.Nombre, c.Precio, c.Descripcion, c.Foto FROM productos p INNER JOIN cama c ON p.id_cama = c.id_cama;");
                     rs = st.executeQuery();
                     while (rs.next()) {
                 %>
                             ...
                             <div class="row">
                                 ...
                                 <div class="col-md-6">
                                     <div class="card-body" style="color: black;">        
                                         ...
                                         <form action="productoVistacamas.jsp" method="post">
                                             <input type="hidden" name="id_camas" value="<%= rs.getInt("id_cama")%>">
