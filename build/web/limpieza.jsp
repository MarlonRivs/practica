...
<html>
        ...
        <style>
            *{
            ...
            body{
                ...
                background-image: url("img/nv6.jpg"); background-size: cover; background-repeat: no-repeat; margin-top: -120px;  background-attachment: fixed;
    ...
    <body>
        ...
        <h1 class='container' style="text-align: left; margin-top: 290px; color:black">Accesorios de limpieza </h1><br>
        ...
        <!-- BUSCADOR -->
              <form class="d-flex container " role="search" style='height:50px; margin-top: 10px;'>
        ...
        <div class="container" style="margin-top: 5px; margin-bottom: 200px;">
            <div class="container">
                <div class="row">
                  <% 
                    int count = 0; // Inicia el conteo de las cartas mostradas.
                    st = conexion.prepareStatement("SELECT p.id_limpieza, n.Nombre, n.Precio, n.Descripcion, n.Foto FROM productos p INNER JOIN limpieza n ON p.id_limpieza = n.id_limpieza;");
                    rs = st.executeQuery();
                    while (rs.next()) {
                  %>
                              ...
                              <div class="col-md-6">
                                  <div class="card-body" style="color: black;">        
                                      ...
                                      <form action="agregarAlCarrito.jsp" method="post">
                                          <input type="hidden" name="id_limpieza" value="<%= rs.getInt("id_limpieza")%>">
